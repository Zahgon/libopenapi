...
func NewServer(server *lowv3.Server) *Server { _ = "STUB: not implemented"; return nil }
...
func (s *Server) MarshalYAML() (interface{}, error) { _ = "STUB: not implemented"; return nil, nil }
